...
@register_task('binmatch_multifield')
class BinmatchMultifieldTask(FairseqTask):
    """
    ...
    def setup_task(cls, args, **kwargs):
        ...
        return BinmatchMultifieldTask(args, data_dictionary_dict, label_dict)
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        dataset = {
            ...
            'ntokens': NumelDataset(input0[field], reduce=True),
        }
    ...
    def build_model(self, args):
        ...
        model.register_classification_head(
            getattr(args, 'classification_head_name', 'binmatch_classification_head'),
